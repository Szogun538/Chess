...
var resp_piece = {
	"queen": preload("res://pieces/queen_b.tscn"),
	"rook": preload("res://pieces/rook_b.tscn"),
	"knight": preload("res://pieces/knight_b.tscn"),
	"bishop": preload("res://pieces/bishop_b.tscn"),
	}
